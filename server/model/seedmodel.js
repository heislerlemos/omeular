...
mongoose.connect(
	"mongodb+srv://heisler:5Myklw7L2tbCWpyO@cluster0.toavd.mongodb.net/omeular?retryWrites=true&w=majority"
);
...
var casas = [
	new Casadb({
		...
		fotografia_da_localização:
			"https://cdn.angocasa.com/images/content/a/p/apartamento-t3-big-97170.jpg",
	...
	new Casadb({
		...
		estado_do_bairro: "Bom",
		fotografia_da_localização:
			"https://cdn.angocasa.com/images/content/1/-/1-big-70401.jpg",
	...
	new Casadb({
		...
		fotografia_da_localização:
			"https://cdn.angocasa.com/images/content/a/p/apartamento-t3-big-91118.jpg",
	...
	new Casadb({
		...
		estado_do_bairro: "Bom",
		fotografia_da_localização:
			"https://cdn.angocasa.com/images/content/a/p/apartamento-t3-em-centralidade-do-kilamba-big-22355.jpg",
	...
	new Casadb({
		...
		estado_do_bairro: "Mal",
		fotografia_da_localização:
			"https://cdn.angocasa.com/images/content/a/p/apartamento-t2-big-70619.jpeg",
